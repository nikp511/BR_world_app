 ...
 */
public class MoreLikeAdapter extends RecyclerView.Adapter<MoreLikeAdapter.MyViewHolder> {
    Context context;

    CustomClick customClick;
    private List<PojoDetail.LikeThi> mArrayData;
    ...
    public MoreLikeAdapter(Context context, List<PojoDetail.LikeThi> mArrayData, CustomClick customClick) {
